...
from tensorflow.keras.layers import Dense, Input, LSTM, Embedding, Dropout, Activation, Conv1D, MaxPooling1D, Flatten
...
class YangCNN(Classifier):
    ...
    def __init__(self) -> None:
        ...
        self.model.add(Conv1D(128,5,strides=1,padding='valid'))
        self.model.add(Activation('relu'))
        self.model.add(MaxPooling1D(pool_size=4, strides=None, padding='valid'))
        ...
        self.model.compile(loss='binary_crossentropy', optimizer='rmsprop', metrics=CommonData.metrics)
