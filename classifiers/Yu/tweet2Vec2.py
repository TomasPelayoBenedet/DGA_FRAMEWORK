...
from tensorflow.keras.layers import Dense, Input, LSTM, Embedding, Dropout, Activation, Bidirectional, Conv1D, MaxPooling1D
...
class Tweet2Vec2(Classifier):
    ...
    def __init__(self) -> None:
        ...
        self.model.add(Conv1D(filters=128, kernel_size=3, padding='same', activation='relu', strides=1))
