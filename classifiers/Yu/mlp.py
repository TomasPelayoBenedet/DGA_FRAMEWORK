...
from tensorflow.keras.layers import Dense, ThresholdedReLU, Conv1D, MaxPooling1D, Flatten, Dropout, Embedding, Lambda,Reshape
...
class MLP(Classifier):
    ...
    def __init__(self) -> None:
        ...
        self.model.add(Flatten()) # Added this layer to run correctly
